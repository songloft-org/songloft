...
- 🔁 **歌单转本地** — 把歌单中的网络歌曲离线下载到本地音乐库，按歌单分目录、可读文件名命名，转换后回写元数据 / 封面 / 歌词（请确保你对原始内容拥有合法使用权）
...
- 🔌 **第三方插件免责** — JS 插件由第三方社区维护，其接入的任何网络音源、元数据、歌词内容版权均归原权利人所有。**使用网络音源、歌单转本地等功能下载或转存内容时，用户须自行承担版权合规责任**，并遵守所在国家 / 地区的法律法规
