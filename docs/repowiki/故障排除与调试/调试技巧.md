...
## 简介
本指南面向 MiMusic 的开发者与运维人员，聚焦"调试技巧与工具使用"。内容覆盖：
...
## 结论
本指南梳理了 MiMusic 的调试体系：后端基于 slog 的日志、前端基于 vConsole/Tracely 的可观测性、插件基于 WASM 与宿主函数的隔离调试。配合 DevTools、基准测试与缓存策略，可系统性提升问题定位与性能优化效率。
