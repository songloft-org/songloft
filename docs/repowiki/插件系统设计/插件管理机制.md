...
- [plugins/mimusic-plugin-xiaomi/pkg/qrcode/qrcode.go](file://plugins/mimusic-plugin-xiaomi/pkg/qrcode/qrcode.go)
- [plugins/mimusic-plugin-cloudflared/downloader.go](file://plugins/mimusic-plugin-cloudflared/downloader.go)
- [go.mod](file://go.mod)
...
LOCAL["localStorage 存储<br/>mimusic-auth"]
...
2. **构建工具**：使用 @mimusic/plugin-builder 进行打包
