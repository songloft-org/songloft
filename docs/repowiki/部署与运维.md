...
- [Dockerfile](https://github.com/songloft-org/songloft/blob/main/Dockerfile) -- 多阶段 Docker 构建定义
- [scripts/docker-entrypoint.sh](https://github.com/songloft-org/songloft/blob/main/scripts/docker-entrypoint.sh) -- 容器启动入口与热替换逻辑
- [internal/services/upgrade_service.go](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go) -- 在线升级服务（下载/测试/原子替换/回退）
- [internal/app/app.go](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go) -- 应用初始化、配置解析、Start 方法
- [internal/app/embed.go](https://github.com/songloft-org/songloft/blob/main/internal/app/embed.go) -- SPA 静态文件服务与 base href 注入
- [internal/config/types.go](https://github.com/songloft-org/songloft/blob/main/internal/config/types.go) -- 启动配置结构 AppConfig
- [internal/version/version.go](https://github.com/songloft-org/songloft/blob/main/internal/version/version.go) -- 版本号编译时注入
- [internal/tracelycfg/tracelycfg.go](https://github.com/songloft-org/songloft/blob/main/internal/tracelycfg/tracelycfg.go) -- Tracely 监控编译时注入
- [internal/httputil/proxy.go](https://github.com/songloft-org/songloft/blob/main/internal/httputil/proxy.go) -- 全局 HTTP 代理配置
...
- [internal/services/auth_service.go](https://github.com/songloft-org/songloft/blob/main/internal/services/auth_service.go) -- JWT 密钥生成与认证
- [Makefile](https://github.com/songloft-org/songloft/blob/main/Makefile) -- 构建系统（VERSION/BUILD_TYPE/LDFLAGS）
...
**章节来源**
- [Dockerfile:1-99](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L1-L99) -- 完整 Docker 构建与运行时定义
- [internal/app/app.go:459-483](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L459-L483) -- Start 方法与 base-path 路由挂载
...
**章节来源**
- [Makefile:4-26](https://github.com/songloft-org/songloft/blob/main/Makefile#L4-L26) -- VERSION、BUILD_TYPE、LDFLAGS 定义
- [Makefile:100-125](https://github.com/songloft-org/songloft/blob/main/Makefile#L100-L125) -- 四种构建目标
- [internal/version/version.go:1-24](https://github.com/songloft-org/songloft/blob/main/internal/version/version.go#L1-L24) -- 版本号变量定义
...
**图表来源**
- [Dockerfile:1-58](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L1-L58) -- 构建阶段
- [Dockerfile:59-99](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L59-L99) -- 运行时阶段
...
**章节来源**
- [Dockerfile:84-97](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L84-L97) -- VOLUME 与 ENV 声明
- [internal/app/app.go:547-637](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L547-L637) -- ParseConfig 环境变量解析
...
**章节来源**
- [scripts/docker-entrypoint.sh:1-173](https://github.com/songloft-org/songloft/blob/main/scripts/docker-entrypoint.sh#L1-L173) -- 完整入口脚本
- [scripts/docker-entrypoint.sh:16-64](https://github.com/songloft-org/songloft/blob/main/scripts/docker-entrypoint.sh#L16-L64) -- 版本比较函数
- [scripts/docker-entrypoint.sh:92-159](https://github.com/songloft-org/songloft/blob/main/scripts/docker-entrypoint.sh#L92-L159) -- 热替换决策逻辑
...
**章节来源**
- [internal/app/app.go:547-637](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L547-L637) -- ParseConfig 参数解析
- [internal/app/app.go:510-528](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L510-L528) -- showHelp 输出
- [internal/config/types.go:1-12](https://github.com/songloft-org/songloft/blob/main/internal/config/types.go#L1-L12) -- AppConfig 结构定义
...
**章节来源**
- [internal/app/app.go:531-544](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L531-L544) -- normalizeBasePath 规范化
- [internal/app/app.go:472-480](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L472-L480) -- StripPrefix 路由挂载
- [internal/app/embed.go:39-54](https://github.com/songloft-org/songloft/blob/main/internal/app/embed.go#L39-L54) -- base href 运行时替换
...
**章节来源**
- [internal/services/upgrade_service.go:22-32](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L22-L32) -- 版本文件 URL 与二进制路径常量
- [internal/services/upgrade_service.go:278-337](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L278-L337) -- UpgradeBinary 完整流程
- [internal/services/upgrade_service.go:399-456](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L399-L456) -- ResetToBaseImage 回退逻辑
- [internal/services/upgrade_service.go:150-200](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L150-L200) -- 底包 BUILD_TYPE 检测与平台后缀
...
**章节来源**
- [internal/tracelycfg/tracelycfg.go:1-11](https://github.com/songloft-org/songloft/blob/main/internal/tracelycfg/tracelycfg.go#L1-L11) -- 编译时注入变量与 Enabled 判断
- [internal/app/app.go:325-361](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L325-L361) -- Tracely 初始化与事件上报
- [Makefile:24-26](https://github.com/songloft-org/songloft/blob/main/Makefile#L24-L26) -- TRACELY_* 构建参数
...
**章节来源**
- [internal/app/app.go:459-465](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L459-L465) -- 默认凭证提示
- [internal/app/app.go:486-509](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L486-L509) -- initJWTSecret 流程
- [internal/services/auth_service.go:85-92](https://github.com/songloft-org/songloft/blob/main/internal/services/auth_service.go#L85-L92) -- GenerateSecret 实现
...
- [internal/httputil/proxy.go:41-52](https://github.com/songloft-org/songloft/blob/main/internal/httputil/proxy.go#L41-L52) -- loopback 地址跳过代理
...
**章节来源**
- [Dockerfile:60-69](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L60-L69) -- ALSA 运行时库安装
- [internal/services/upgrade_service.go:55-57](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L55-L57) -- Docker 环境检测
...
**章节来源**
- [internal/app/app.go:87-92](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L87-L92) -- 日志等级动态切换
- [internal/services/upgrade_service.go:35-52](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L35-L52) -- UpgradeService 结构与 HTTP 客户端
