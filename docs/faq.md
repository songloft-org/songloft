...
- **Flutter 客户端**：从 [Flutter 客户端 Releases](https://github.com/mimusic-org/mimusic-player/releases) 下载预编译安装包，支持 Android、iOS、macOS、Windows、Linux 和 Web。
...
- **Flutter 客户端**: [https://github.com/mimusic-org/mimusic-player](https://github.com/mimusic-org/mimusic-player)
