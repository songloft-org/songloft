...
- [internal/app/app.go](file://internal/app/app.go) -- The creation and wiring order of all core components in App.Init()
- [internal/app/routers.go](file://internal/app/routers.go) -- Route groups: authentication, songs, playlists, scan, cache, settings, upgrade, etc.
