...
- [internal/app/routers.go](file://internal/app/routers.go) -- middleware stack assembly and route registration
- [internal/app/compress.go](file://internal/app/compress.go) -- precompressed static asset serving
- [internal/app/access_log.go](file://internal/app/access_log.go) -- slog access log bridge
- [internal/middleware/auth.go](file://internal/middleware/auth.go) -- JWT authentication middleware
- [internal/httputil/proxy.go](file://internal/httputil/proxy.go) -- global HTTP proxy
- [internal/httputil/basicauth.go](file://internal/httputil/basicauth.go) -- URL-embedded credential extraction
- [internal/services/whitelist.go](file://internal/services/whitelist.go) -- SSRF protection allowlist
...
**Section sources**
- [internal/app/routers.go:237-349](file://internal/app/routers.go#L237-L349) -- `setupBaseRouter` middleware registration order
...
**Section sources**
- [internal/app/routers.go:239-249](file://internal/app/routers.go#L239-L249) -- Compress middleware registration and MIME type list
- [internal/app/compress.go:32-78](file://internal/app/compress.go#L32-L78) -- `newPrecompressedFS` loading logic
- [internal/app/compress.go:106-146](file://internal/app/compress.go#L106-L146) -- `serve` method: encoding negotiation and ETag
...
**Section sources**
- [internal/app/access_log.go:1-49](file://internal/app/access_log.go#L1-L49) -- complete implementation
...
**Section sources**
- [internal/app/routers.go:255-275](file://internal/app/routers.go#L255-L275) -- Tracely reporting + Recoverer registration
...
**Section sources**
- [internal/app/routers.go:279-337](file://internal/app/routers.go#L279-L337) -- complete CORS middleware configuration
...
**Section sources**
- [internal/middleware/auth.go:23-26](file://internal/middleware/auth.go#L23-L26) -- `PublicPathChecker` interface definition
- [internal/middleware/auth.go:28-88](file://internal/middleware/auth.go#L28-L88) -- `AuthMiddleware` complete implementation
...
**Section sources**
- [internal/httputil/proxy.go:1-84](file://internal/httputil/proxy.go#L1-L84) -- complete global proxy implementation
- [internal/httputil/basicauth.go:1-15](file://internal/httputil/basicauth.go#L1-L15) -- URL credential extraction
