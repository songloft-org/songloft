...
- [AGENTS.md](file://AGENTS.md) -- Project entry information: common commands, database standards, coding conventions, API documentation standards, Git conventions, build and deployment
- [Makefile](file://Makefile) -- All Make targets for build, test, code generation, Docker, etc.
- [Dockerfile](file://Dockerfile) -- Multi-stage Docker build flow and runtime environment
- [sqlc.yaml](file://sqlc.yaml) -- sqlc code generation configuration (engine, input/output paths, generation options)
- [go.mod](file://go.mod) -- Go module declaration, version requirements, and dependency list
...
**Section sources**
- [go.mod:1-3](file://go.mod#L1-L3) -- Module name and Go version requirement
- [Makefile:3-4](file://Makefile#L3-L4) -- `CGO_ENABLED=0` and `GO_VERSION`
- [Dockerfile:59-69](file://Dockerfile#L59-L69) -- Runtime image dependencies
...
- [Makefile:57-95](file://Makefile#L57-L95) -- Frontend build targets
- [AGENTS.md:30-49](file://AGENTS.md#L30-L49) -- Common commands quick reference
...
**Section sources**
- [AGENTS.md:70-77](file://AGENTS.md#L70-L77) -- Backend coding conventions
- [go.mod:6-10](file://go.mod#L6-L10) -- Core dependencies (squirrel, chi, jwt)
...
**Section sources**
- [AGENTS.md:54-66](file://AGENTS.md#L54-L66) -- Database standards (iron law)
- [sqlc.yaml:1-17](file://sqlc.yaml#L1-L17) -- Complete sqlc configuration
- [go.mod:6](file://go.mod#L6) -- squirrel dependency; [go.mod:14](file://go.mod#L14) -- goose dependency
...
**Section sources**
- [AGENTS.md:82-123](file://AGENTS.md#L82-L123) -- API documentation standards (iron law)
- [Makefile:329-337](file://Makefile#L329-L337) -- `make swagger` target
...
**Section sources**
- [AGENTS.md:65-66](file://AGENTS.md#L65-L66) -- Testing standards
- [Makefile:206-234](file://Makefile#L206-L234) -- Test Make targets
...
**Section sources**
- [AGENTS.md:178-185](file://AGENTS.md#L178-L185) -- Build tags and matrix
- [Makefile:1-4](file://Makefile#L1-L4) -- `CGO_ENABLED=0`
- [Makefile:19-26](file://Makefile#L19-L26) -- LDFLAGS injection
- [Dockerfile:1-57](file://Dockerfile#L1-L57) -- Multi-stage build flow
...
**Section sources**
- [AGENTS.md:169-173](file://AGENTS.md#L169-L173) -- Git commit conventions
- [Makefile:339-341](file://Makefile#L339-L341) -- `make bump` target
