...
- [Dockerfile](https://github.com/songloft-org/songloft/blob/main/Dockerfile) -- Multi-stage Docker build definition
- [scripts/docker-entrypoint.sh](https://github.com/songloft-org/songloft/blob/main/scripts/docker-entrypoint.sh) -- Container startup entry point and hot-replacement logic
- [internal/services/upgrade_service.go](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go) -- Online upgrade service (download/test/atomic replace/rollback)
- [internal/app/app.go](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go) -- Application initialization, config parsing, Start method
- [internal/app/embed.go](https://github.com/songloft-org/songloft/blob/main/internal/app/embed.go) -- SPA static file serving and base href injection
- [internal/config/types.go](https://github.com/songloft-org/songloft/blob/main/internal/config/types.go) -- Startup configuration structure AppConfig
- [internal/version/version.go](https://github.com/songloft-org/songloft/blob/main/internal/version/version.go) -- Version number compile-time injection
- [internal/tracelycfg/tracelycfg.go](https://github.com/songloft-org/songloft/blob/main/internal/tracelycfg/tracelycfg.go) -- Tracely monitoring compile-time injection
- [internal/httputil/proxy.go](https://github.com/songloft-org/songloft/blob/main/internal/httputil/proxy.go) -- Global HTTP proxy configuration
- [internal/services/whitelist.go](https://github.com/songloft-org/songloft/blob/main/internal/services/whitelist.go) -- SSRF protection (private network blocking)
- [internal/services/auth_service.go](https://github.com/songloft-org/songloft/blob/main/internal/services/auth_service.go) -- JWT secret generation and authentication
- [Makefile](https://github.com/songloft-org/songloft/blob/main/Makefile) -- Build system (VERSION/BUILD_TYPE/LDFLAGS)
...
**Section sources**
- [Dockerfile:1-99](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L1-L99) -- Complete Docker build and runtime definition
- [internal/app/app.go:459-483](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L459-L483) -- Start method and base-path route mounting
...
**Section sources**
- [Makefile:4-26](https://github.com/songloft-org/songloft/blob/main/Makefile#L4-L26) -- VERSION, BUILD_TYPE, LDFLAGS definitions
- [Makefile:100-125](https://github.com/songloft-org/songloft/blob/main/Makefile#L100-L125) -- The four build targets
- [internal/version/version.go:1-24](https://github.com/songloft-org/songloft/blob/main/internal/version/version.go#L1-L24) -- Version number variable definitions
...
**Diagram sources**
- [Dockerfile:1-58](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L1-L58) -- Build stage
- [Dockerfile:59-99](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L59-L99) -- Runtime stage
...
**Section sources**
- [Dockerfile:84-97](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L84-L97) -- VOLUME and ENV declarations
- [internal/app/app.go:547-637](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L547-L637) -- ParseConfig environment variable parsing
...
**Section sources**
- [scripts/docker-entrypoint.sh:1-173](https://github.com/songloft-org/songloft/blob/main/scripts/docker-entrypoint.sh#L1-L173) -- Complete entrypoint script
- [scripts/docker-entrypoint.sh:16-64](https://github.com/songloft-org/songloft/blob/main/scripts/docker-entrypoint.sh#L16-L64) -- Version comparison function
- [scripts/docker-entrypoint.sh:92-159](https://github.com/songloft-org/songloft/blob/main/scripts/docker-entrypoint.sh#L92-L159) -- Hot-replacement decision logic
...
**Section sources**
- [internal/app/app.go:547-637](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L547-L637) -- ParseConfig argument parsing
- [internal/app/app.go:510-528](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L510-L528) -- showHelp output
- [internal/config/types.go:1-12](https://github.com/songloft-org/songloft/blob/main/internal/config/types.go#L1-L12) -- AppConfig structure definition
...
**Section sources**
- [internal/app/app.go:531-544](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L531-L544) -- normalizeBasePath normalization
- [internal/app/app.go:472-480](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L472-L480) -- StripPrefix route mounting
- [internal/app/embed.go:39-54](https://github.com/songloft-org/songloft/blob/main/internal/app/embed.go#L39-L54) -- base href runtime replacement
...
**Section sources**
- [internal/services/upgrade_service.go:22-32](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L22-L32) -- Version file URL and binary path constants
- [internal/services/upgrade_service.go:278-337](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L278-L337) -- Complete UpgradeBinary flow
- [internal/services/upgrade_service.go:399-456](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L399-L456) -- ResetToBaseImage rollback logic
- [internal/services/upgrade_service.go:150-200](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L150-L200) -- Base binary BUILD_TYPE detection and platform suffix
...
**Section sources**
- [internal/tracelycfg/tracelycfg.go:1-11](https://github.com/songloft-org/songloft/blob/main/internal/tracelycfg/tracelycfg.go#L1-L11) -- Compile-time injection variables and the Enabled check
- [internal/app/app.go:325-361](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L325-L361) -- Tracely initialization and event reporting
- [Makefile:24-26](https://github.com/songloft-org/songloft/blob/main/Makefile#L24-L26) -- TRACELY_* build parameters
...
**Section sources**
- [internal/app/app.go:459-465](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L459-L465) -- Default credentials notice
- [internal/app/app.go:486-509](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L486-L509) -- initJWTSecret flow
- [internal/services/auth_service.go:85-92](https://github.com/songloft-org/songloft/blob/main/internal/services/auth_service.go#L85-L92) -- GenerateSecret implementation
...
- [internal/httputil/proxy.go:41-52](https://github.com/songloft-org/songloft/blob/main/internal/httputil/proxy.go#L41-L52) -- Loopback addresses skip the proxy
...
**Section sources**
- [Dockerfile:60-69](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L60-L69) -- ALSA runtime library installation
- [internal/services/upgrade_service.go:55-57](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L55-L57) -- Docker environment detection
...
**Section sources**
- [internal/app/app.go:87-92](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L87-L92) -- Dynamic log level switching
- [internal/services/upgrade_service.go:35-52](https://github.com/songloft-org/songloft/blob/main/internal/services/upgrade_service.go#L35-L52) -- UpgradeService structure and HTTP client
