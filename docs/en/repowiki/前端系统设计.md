...
|------|------|------|
| Android | ExoPlayer (just_audio default) | Native support for MP3/FLAC/OGG/M4A/WAV/Opus |
| iOS | AVPlayer (just_audio default) | Native support for MP3/FLAC/M4A/ALAC/AIFF |
| Web | HTML5 Audio | Supports MP3/FLAC/OGG/M4A/WAV/Opus |
| Windows/Linux | media_kit (libmpv) | Bridged via `just_audio_media_kit` |
| macOS | AVPlayer (just_audio default) | Same as iOS |
...
| Audio backend | ExoPlayer | AVPlayer | HTML5 Audio | AVPlayer | media_kit | media_kit |
